 ...
 **/
!function (e, t, i, n) {
    var a = 30, r = 90, s = 40, c = 10, l = e.rad2deg = function (e) {
        return e / (Math.PI / 180)
    }, o = (e.deg2rad = function (e) {
        return e * (Math.PI / 180)
    }, navigator.platform.toLowerCase()), d = navigator.userAgent.toLowerCase(), u = (d.indexOf("iphone") > -1 || d.indexOf("ipad") > -1 || d.indexOf("ipod") > -1) && (o.indexOf("iphone") > -1 || o.indexOf("ipad") > -1 || o.indexOf("ipod") > -1), p = e.Picker = function (e, t) {
        var i = this;
    ...
    p.prototype.findElementItems = function () {
        ...
        e %= t.d;
        var a = (i * i + b * b - e * e) / (2 * i * b), r = n + l(Math.acos(a));
        return r
        ...
        t.holder.addEventListener(e.EVENT_START, function (e) {
            ...
            if (a) {
                e.preventDefault();
                var r = (e.changedTouches ? e.changedTouches[0] : e).pageY, s = r - n, c = t.calcAngle(s), l = s > 0 ? i - c : i + c;
        ...
        var i = this, n = e.changedTouches ? e.changedTouches[0] : e;
        ...
        var t = this, i = e.changedTouches ? e.changedTouches[0] : e, n = e.timeStamp || Date.now(), a = (i.pageY - t.lastMoveStart) / (n - t.lastMoveTime), r = a > 0 ? -1 : 1, s = 6e-4 * r * -1, c = Math.abs(a / s), l = a * c / 2, o = t.list.angle, d = t.calcAngle(l) * r, u = d;
        ...
        var i = this;
        setTimeout(function () {
            var n = i.getSelectedIndex(), a = i.items[n];
        ...
        return this.each(function (t, i) {
            if (!i.picker)if (e)i.picker = new p(i, e); else {
                var n = i.getAttribute("data-picker-options"), a = n ? JSON.parse(n) : {};
                i.picker = new p(i, a)
            }
    ...
    var i = '<div class="mui-poppicker">		<div class="mui-poppicker-header">			<button class="mui-btn mui-poppicker-btn-cancel">取消</button>			<button class="mui-btn mui-btn-blue mui-poppicker-btn-ok">确定</button>			<div class="mui-poppicker-clear"></div>		</div>		<div class="mui-poppicker-body">		</div>	</div>', n = '<div class="mui-picker">		<div class="mui-picker-inner">			<div class="mui-pciker-rule mui-pciker-rule-ft"></div>			<ul class="mui-pciker-list">			</ul>			<div class="mui-pciker-rule mui-pciker-rule-bg"></div>		</div>	</div>';
    e.PopPicker = e.Class.extend({
        init: function (n) {
            ...
            var t = this, i = t.options.layer || 1, a = 100 / i + "%";
            t.pickers = [];
            for (var r = 1; i >= r; r++) {
                var s = e.dom(n)[0];
    ...
    e.DtPicker = e.Class.extend({
        init: function (n) {
            ...
            var e = this, t = e.ui, i = e.options.type, n = {
                type: i,
            ...
            var t = this, i = t.ui, n = t._parseValue(e);
            ...
            var t = this, i = t.options, n = t.ui, a = [];
